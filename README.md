...
| | **presentation** | Create presentations following Patrick Winston's how-to-speak methodology. | `/presentation:start` `/presentation:brain-dump` `/presentation:shape` `/presentation:outline` `/presentation:author` |
